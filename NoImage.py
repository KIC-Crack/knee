...
class NoImageWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
  ...
  def WidgetShow(self,index):
    ...
    if index == 5:#导航
      ...
      djoperationWidget.resize(420,500)
...
#向小屏幕发送选取点位的信息
  ...
  def onAdjustment(self):
    ...
    slicer.modules.popup.widgetRepresentation().setGeometry(-30,0,450,500)
  ...
  def TibiaJieGu(self):
    ...
    rotationTransformNode = slicer.util.getNode('TibiaToTracker')
    ...
    point1_ni = np.dot(TibiaTrans_ni, point1)
    angle_point=(point1_ni-point_ni)[0:2]
  ...
  def onAdjustment2(self):
    ...
    slicer.modules.tibiapopup.widgetRepresentation().setGeometry(-15,0,450,500)
